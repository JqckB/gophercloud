...
import (
	...
	baremetalHTTPBasic "github.com/JqckB/gophercloud/v2/openstack/baremetal/httpbasic"
	baremetalNoAuth "github.com/JqckB/gophercloud/v2/openstack/baremetal/noauth"
	blockstorageNoAuth "github.com/JqckB/gophercloud/v2/openstack/blockstorage/noauth"
)
...
func AcceptanceTestChoicesFromEnv() (*AcceptanceTestChoices, error) {
	...
	/* // Temporarily disabled, see https://github.com/JqckB/gophercloud/issues/1345
	if networkID == "" {
...
func NewBlockStorageV1Client() (*gophercloud.ServiceClient, error) {
	...
	return openstack.NewBlockStorageV1(context.TODO(), client, gophercloud.EndpointOpts{
...
func NewBlockStorageV2Client() (*gophercloud.ServiceClient, error) {
	...
	return openstack.NewBlockStorageV2(context.TODO(), client, gophercloud.EndpointOpts{
		Region: os.Getenv("OS_REGION_NAME"),
	})
}
...
func NewBlockStorageV3Client() (*gophercloud.ServiceClient, error) {
	...
	return openstack.NewBlockStorageV3(context.TODO(), client, gophercloud.EndpointOpts{
		Region: os.Getenv("OS_REGION_NAME"),
	})
}
