...
import (
	...
	"github.com/JqckB/gophercloud/v2/openstack/networking/v2/extensions/provider"
	"github.com/JqckB/gophercloud/v2/openstack/networking/v2/networks"
	nettest "github.com/JqckB/gophercloud/v2/openstack/networking/v2/networks/testing"
...
func TestCreate(t *testing.T) {
	...
	err := networks.Create(context.TODO(), fake.ServiceClient(fakeServer), options).ExtractInto(&s)
	th.AssertNoErr(t, err)
		...
		fmt.Fprint(w, `
{
	...
	_, err := networks.Create(context.TODO(), fake.ServiceClient(fakeServer), providerCreateOpts).Extract()
	th.AssertNoErr(t, err)
}
...
func TestUpdate(t *testing.T) {
  ...
  "network": {
	...
	err := networks.Update(context.TODO(), fake.ServiceClient(fakeServer), "4e8e5957-649f-477b-9e5b-f1f75b21c03c", providerUpdateOpts).ExtractInto(&s)
	th.AssertNoErr(t, err)
